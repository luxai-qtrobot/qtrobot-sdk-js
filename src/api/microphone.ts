...
export type MicrophoneSetIntTuningOptions = {
  /** Respeaker parameter name, e.g. "AECNORM". */
  name: string
...
export class MicrophoneApi {
   ...
   */
  async getIntTuning(): Promise<Record<string, unknown>> {
    return this._robot.rpcCall<Record<string, unknown>>('/microphone/int/tunning/get', {})
  }

  /**
   * Set a single internal microphone tuning parameter.
   * @param options.name Respeaker parameter name, e.g. "AECNORM".
   * @param options.value Numeric value to set.
   * @returns boolean
   */
  async setIntTuning(options: MicrophoneSetIntTuningOptions): Promise<boolean> {
    return this._robot.rpcCall<boolean>('/microphone/int/tunning/set', options as Record<string, unknown>)
  }
   ...
   *   // handle frame
   * }
   * @param options.queueSize Internal frame buffer size (default: 10).
   */
  intAudioCh0Reader(options?: { queueSize?: number }): TypedStreamReader<AudioFrameRaw> {
    return this._robot.getStreamReader<AudioFrameRaw>(
      '/mic/int/audio/ch0/stream:o',
      raw => Frame.fromDict(raw as Record<string, unknown>) as AudioFrameRaw,
      options?.queueSize,
   ...
   * @param options.queueSize Internal frame buffer size (default: 10).
   */
  intAudioCh1Reader(options?: { queueSize?: number }): TypedStreamReader<AudioFrameRaw> {
    return this._robot.getStreamReader<AudioFrameRaw>(
      '/mic/int/audio/ch1/stream:o',
      raw => Frame.fromDict(raw as Record<string, unknown>) as AudioFrameRaw,
      options?.queueSize,
   ...
   * @param options.queueSize Internal frame buffer size (default: 10).
   */
  intAudioCh2Reader(options?: { queueSize?: number }): TypedStreamReader<AudioFrameRaw> {
    return this._robot.getStreamReader<AudioFrameRaw>(
      '/mic/int/audio/ch2/stream:o',
      raw => Frame.fromDict(raw as Record<string, unknown>) as AudioFrameRaw,
      options?.queueSize,
   ...
   * @param options.queueSize Internal frame buffer size (default: 10).
   */
  intAudioCh3Reader(options?: { queueSize?: number }): TypedStreamReader<AudioFrameRaw> {
    return this._robot.getStreamReader<AudioFrameRaw>(
      '/mic/int/audio/ch3/stream:o',
      raw => Frame.fromDict(raw as Record<string, unknown>) as AudioFrameRaw,
      options?.queueSize,
   ...
   * @param options.queueSize Internal frame buffer size (default: 10).
   */
  intAudioCh4Reader(options?: { queueSize?: number }): TypedStreamReader<AudioFrameRaw> {
    return this._robot.getStreamReader<AudioFrameRaw>(
      '/mic/int/audio/ch4/stream:o',
      raw => Frame.fromDict(raw as Record<string, unknown>) as AudioFrameRaw,
      options?.queueSize,
   ...
   */
  intEventReader(options?: { queueSize?: number }): TypedStreamReader<Record<string, unknown>> {
    return this._robot.getStreamReader<Record<string, unknown>>(
      '/mic/int/event/stream:o',
      raw => ((raw as { value?: Record<string, unknown> }).value ?? raw as Record<string, unknown>),
      options?.queueSize,
   ...
   * @param options.queueSize Internal frame buffer size (default: 10).
   */
  extAudioCh0Reader(options?: { queueSize?: number }): TypedStreamReader<AudioFrameRaw> {
    return this._robot.getStreamReader<AudioFrameRaw>(
      '/mic/ext/audio/ch0/stream:o',
      raw => Frame.fromDict(raw as Record<string, unknown>) as AudioFrameRaw,
      options?.queueSize,
